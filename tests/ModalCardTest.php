...
final class ModalCardTest extends TestCase
{
    ...
    public function testImmutability(): void
    {
        ...
        $this->assertNotSame($widget, $widget->modalCardBackgroundClass(''));
        $this->assertNotSame($widget, $widget->modalCardBodyClass(''));
        $this->assertNotSame($widget, $widget->modalCardButtonClass(''));
        $this->assertNotSame($widget, $widget->modalCardClass(''));
        $this->assertNotSame($widget, $widget->modalCardContentClass(''));
        $this->assertNotSame($widget, $widget->modalCardFootClass(''));
        $this->assertNotSame($widget, $widget->modalCardHeadClass(''));
        $this->assertNotSame($widget, $widget->modalCardTitleClass(''));
